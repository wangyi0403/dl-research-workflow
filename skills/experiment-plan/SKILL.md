...
- **OUTPUT_DIR = `docs/refine-logs/`** — Default destination for experiment planning artifacts.
...
- `docs/04_final_proposal.md` (required)
- `docs/review_summary.md` (if exists — reviewer concerns from research-refine-pipeline)
- `docs/refinement_report.md` (if exists — refinement history from research-refine)
...
#### Step 5.1: Write `docs/05_experiment_plan.md`
...
#### Step 5.2: Write `docs/06_experiment_tracker.md`
...
Plan file: docs/05_experiment_plan.md
Tracker file: docs/06_experiment_tracker.md
```
