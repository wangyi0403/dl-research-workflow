...
- **REVIEWER_MODEL = `claude-sonnet-4-6`** — Model used via Agent self-review for figure quality review.

## Inputs

1. **docs/13_paper_plan.md** — figure plan table (from `/paper-plan`)
...
If no docs/13_paper_plan.md exists, scan for data files and ask the user which figures to generate.

## Workflow

### Step 1: Read Figure Plan

Parse the Figure Plan table from docs/13_paper_plan.md:
...
Send figure descriptions and captions to Agent for review:
